...
if __name__ == '__main__':
    ...
    DATA_PATH = '/share/wuweijia/Data/VideoText/ICDAR21SVTS/SVTS'
    ...
    for split in SPLITS:
        if split == "test":
            ...
            ann_path_ = os.path.join(DATA_PATH, 'train/annotations')
...
#                 continue
            ...
            img_path = seq_path
            ann_path = os.path.join(ann_path_, seq + ".xml")
            ...
            for i in range(num_images):
                if i < image_range[0] or i > image_range[1]:
                    continue
                img = cv2.imread(os.path.join(data_path, '{}/{}.jpg'.format(seq, i + 1)))
#                 print(os.path.join(data_path, '{}/{:06d}.jpg'.format(seq, i + 1)))
                height, width = img.shape[:2]
                image_info = {'file_name': '{}/{}.jpg'.format(seq, i + 1),  # image name.
